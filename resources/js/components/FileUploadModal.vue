        ...
        <form @submit.prevent="$emit('upload', files);files=[]">
            ...
            <div class="mb-3">
                ...
                <div class="position-relative mt-3">
                    ...
                    <input ref="pasteInput" @input="$event.target.value = ''" class="position-absolute opacity-0" style="left:0;right:0;top:0;bottom:0" type="text" @drop="paste" @dragenter="onDragover" @mouseleave="onDragleave" @dragleave="onDragleave" />
                </div>
