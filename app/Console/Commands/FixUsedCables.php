...
//        collect($bigCommerceService->getProducts(6, 250)->data)->map(function ($product) use ($connectWiseService, $bigCommerceService) {
//
//            if (!Str::contains($product->sku, '-PROJECT')) {
//                return false;
//            }
//
//            $bigCommerceService->updateProduct($product->id, [
